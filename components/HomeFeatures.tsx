  ...
  return (
    <section className="py-20 px-6 lg:px-20 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 items-stretch">
        {features.map((f) => (
          <div key={f.title} className="bg-white rounded-2xl overflow-hidden border border-blue-50 shadow-xl flex flex-col">
            ...
            <div className="h-52 bg-cover bg-center flex-shrink-0" style={{ backgroundImage: `url(${f.image})` }} />
          </div>
        ))}
      </div>
    </section>
